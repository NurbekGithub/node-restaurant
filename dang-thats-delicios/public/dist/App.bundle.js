...
var DEFAULT_LNG = 71.4703558;
var DEFAULT_LAT = 51.1605227;
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_LAT;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_LNG;
...
function makeMap(mapDiv) {
  ...
  var input = (0, _bling.$)('.map .autocomplete__input');
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        searchResult.innerHTML = (0, _dompurify2.default)(searchResultHTML(res.data));
        return;
      }
      // tell them that nothing came back;
      searchResult.innerHTML = (0, _dompurify2.default)('<div class="search__result">No result for ' + _this.value + ' found!</div>');
    }).catch(function (err) {
      console.error(err);
    });
  });
...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    if (isHearted) {
      ...
      _this.heart.on('animationend', function () {
